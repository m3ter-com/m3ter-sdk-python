...
from m3ter_sdk._constants import RAW_RESPONSE_HEADER
from m3ter_sdk._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
...
def _get_open_connections(client: M3ter | AsyncM3ter) -> int:
...
class TestM3ter:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/organizations/orgId/products").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/organizations/orgId/products").mock(return_value=httpx.Response(500))
