...
class TestCreditLineItems:
    ...
    def test_method_create(self, client: M3ter) -> None:
        ...
        assert_matches_type(CreditLineItem, credit_line_item, path=["response"])
    ...
    def test_method_list(self, client: M3ter) -> None:
        ...
        assert_matches_type(SyncCursor[CreditLineItem], credit_line_item, path=["response"])
...
class TestAsyncCreditLineItems:
    ...
    async def test_method_list(self, async_client: AsyncM3ter) -> None:
        ...
        assert_matches_type(AsyncCursor[CreditLineItem], credit_line_item, path=["response"])
