...
class TestJobs:
    ...
    def test_method_retrieve(self, client: M3ter) -> None:
        ...
        assert_matches_type(FileUploadJob, job, path=["response"])
    ...
    def test_method_list(self, client: M3ter) -> None:
        ...
        assert_matches_type(SyncCursor[FileUploadJob], job, path=["response"])
    ...
    def test_streaming_response_list(self, client: M3ter) -> None:
        with client.usage.file_uploads.jobs.with_streaming_response.list(
            org_id="orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: M3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.usage.file_uploads.jobs.with_raw_response.list(
                org_id="",
            )
...
class TestAsyncJobs:
    ...
    async def test_method_list(self, async_client: AsyncM3ter) -> None:
        ...
        assert_matches_type(AsyncCursor[FileUploadJob], job, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncM3ter) -> None:
        async with async_client.usage.file_uploads.jobs.with_streaming_response.list(
            org_id="orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncM3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.usage.file_uploads.jobs.with_raw_response.list(
                org_id="",
            )
