...
class TestResourceGroups:
    ...
    def test_method_create(self, client: M3ter) -> None:
        ...
        assert_matches_type(ResourceGroup, resource_group, path=["response"])
    ...
    def test_method_list(self, client: M3ter) -> None:
        ...
        assert_matches_type(SyncCursor[ResourceGroup], resource_group, path=["response"])
...
class TestAsyncResourceGroups:
    ...
    async def test_method_list(self, async_client: AsyncM3ter) -> None:
        ...
        assert_matches_type(AsyncCursor[ResourceGroup], resource_group, path=["response"])
