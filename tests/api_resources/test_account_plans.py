...
class TestAccountPlans:
    ...
    def test_method_create(self, client: M3ter) -> None:
        ...
        assert_matches_type(AccountPlan, account_plan, path=["response"])
    ...
    def test_path_params_create(self, client: M3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.account_plans.with_raw_response.create(
                org_id="",
                account_id="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
    ...
    def test_streaming_response_list(self, client: M3ter) -> None:
        with client.account_plans.with_streaming_response.list(
            org_id="orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: M3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.account_plans.with_raw_response.list(
                org_id="",
            )
...
class TestAsyncAccountPlans:
    ...
    async def test_path_params_create(self, async_client: AsyncM3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.account_plans.with_raw_response.create(
                org_id="",
                account_id="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
    ...
    async def test_streaming_response_list(self, async_client: AsyncM3ter) -> None:
        async with async_client.account_plans.with_streaming_response.list(
            org_id="orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncM3ter) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.account_plans.with_raw_response.list(
                org_id="",
            )
