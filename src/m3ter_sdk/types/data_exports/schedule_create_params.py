...
__all__ = ["ScheduleCreateParams", "OperationalDataExportConfigurationRequest", "UsageDataExportConfigurationRequest"]
...
ScheduleCreateParams: TypeAlias = Union[OperationalDataExportConfigurationRequest, UsageDataExportConfigurationRequest]
