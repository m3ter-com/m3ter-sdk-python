    ...
    * **Contract Billing**. Various billing entities associated with an Account can  be linked to Contracts on the Account to meet your specific Contract billing use cases.
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/organizations/{org_id}/contracts", org_id=org_id),
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/organizations/{org_id}/contracts/{id}", org_id=org_id, id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ContractResponse,
    ...
    def end_date_billing_entities(
        ...
        **NOTES:**
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._put(
            path_template("/organizations/{org_id}/contracts/{id}/enddatebillingentities", org_id=org_id, id=id),
            body=maybe_transform(
                {
